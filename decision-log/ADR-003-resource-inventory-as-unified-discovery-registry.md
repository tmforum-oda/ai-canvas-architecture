...
Architecture model:
Canvas CRDs (Source of Truth) -> Canvas Operators / Control Plane -> Resource Inventory API -> Platform Discovery Clients
...
Architecture:
Resource Inventory → Filtered Views → Agent Registry/Tool Registry/Model Registry
...
Architecture:
AIGatewayConfig CRD → Canvas Control Plane → Resource Inventory → Model Registry View
