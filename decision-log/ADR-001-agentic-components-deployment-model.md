...
TM Forum has adopted the A2A Protocol as the open standard for exposing agent skills and capabilities (see https://github.com/tmforum-oda/oda-ca-docs/blob/9ef52c078d8f0d72a2d419ba702fdcd8efd6d2d6/Decision-Log/0019-adopt-a2a-protocol-for-agent-skill-exposure.md).
